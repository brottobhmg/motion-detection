...
// Function to handle capture request
...
// Function to handle IP address request
static esp_err_t ip_handler(httpd_req_t *req){
  String ip = WiFi.localIP().toString();
  return httpd_resp_send(req, ip.c_str(), ip.length());
}
...
void startCameraServer(){
  ...
  if (httpd_start(&stream_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(stream_httpd, &ip_uri);
  }
}
